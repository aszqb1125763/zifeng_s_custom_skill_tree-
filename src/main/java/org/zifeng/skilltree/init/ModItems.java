...
public class ModItems {
    ...
    public static final DeferredItem<BlockItem> SKILL_POINT_CONVERTER_ITEM = ITEMS.registerSimpleBlockItem("star_energy_converter", ModBlocks.STAR_ENERGY_CONVERTER);
