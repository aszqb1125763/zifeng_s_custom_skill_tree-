...
public final class Skills {
    ...
    // 木棍工具·机械共鸣区块技能（2026-09-08，无机械之星前置，1级 50 点）：
    public static final String MACHINE_ZONE_PLACE = "machine_zone_place";       // 选区放置
    public static final String MACHINE_ZONE_EXCAVATE = "machine_zone_excavate"; // 选区挖掘
     ...
     * 目前仅子枫的搬运术（CONTAINER_HAUL）需要——手动模式下把当前打开的容器物品搬进绑定容器，
     * 且【容器 GUI 打开时】也响应。未来新主动技在此登记。
     */
    public static boolean isTriggerBindable(String skillId) {
        return CONTAINER_HAUL.equals(skillId) || BLINK.equals(skillId) // 闪现：改造为触发键传送（2026-09-07 规范）
                || MACHINE_ZONE_PLACE.equals(skillId) || MACHINE_ZONE_EXCAVATE.equals(skillId); // 选区放置/挖掘（2026-09-08）
    }
    ...
    public static String getDisplayName(String skillId) {
        return switch (skillId) {
            ...
            // ===== 木棍工具·机械共鸣区块（2026-09-08，不依赖机械之星） =====
            case MACHINE_ZONE_PLACE, MACHINE_ZONE_EXCAVATE, MACHINE_ZONE_ATTACK, MACHINE_ZONE_PROTECT -> "skill.zifeng_s_custom_skill_tree." + skillId + ".name";
            // ===== 光环（纵列4，领域神通风） =====
    ...
    public static List<Map.Entry<String, Integer>> getPrerequisites(String skillId) {
        return switch (skillId) {
            ...
            // 木棍工具区块技能（2026-09-08）：无机械之星前置；攻击需杀戮伤害 5 级；防护需已学杀戮伤害
