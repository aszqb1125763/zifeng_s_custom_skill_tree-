 ...
 */
public class ResetSkillC2SPacket {
            private final String skillId;

    public ResetSkillC2SPacket(String skillId) {
    ...
    public static ResetSkillC2SPacket decode(FriendlyByteBuf buf) {
        String skillId = buf.readUtf();
        return new ResetSkillC2SPacket(skillId);
    }
    public static void handle(ResetSkillC2SPacket packet, java.util.function.Supplier<NetworkEvent.Context> ctxSupplier) {
