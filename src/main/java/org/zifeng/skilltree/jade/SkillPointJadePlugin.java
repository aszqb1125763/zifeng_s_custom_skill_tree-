...
public class SkillPointJadePlugin implements IWailaPlugin {
    ...
    public void register(IWailaCommonRegistration registration) {
        // 1.20.1 Jade：registerBlockDataProvider 接收 BlockEntity class（1.21.1 才接收 Block class）
        registration.registerBlockDataProvider(SkillPointConverterDataProvider.INSTANCE,
                org.zifeng.skilltree.blockentity.SkillPointConverterBlockEntity.class);
    }
